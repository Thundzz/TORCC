...
/***************************************************************************
    ...
    copyright            : (C) 2013 Bertrand Putigny

  Ce fichier definit le contexte necessaire pour le pilote robot, et est 
 l'interface entre TORCS et la sortie du compilateur que vous devez realiser.
...
enseirbot(tModInfo *modInfo) {
    ...
    modInfo->desc    = strdup("Ceci est un module simple de pilotage.");	/* description of the module (can be long) */
